...
- Call independent tools in the same turn; pass the relevant portfolio_id to portfolio tools.
- If portfolio IDs are provided in context, call tools only for those portfolio IDs.
